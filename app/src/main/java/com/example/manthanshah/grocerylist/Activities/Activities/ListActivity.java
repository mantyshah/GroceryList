...
import com.example.manthanshah.grocerylist.Activities.Interface.RecyclerViewAdapter;
...
//                        .setAction("Action", null).show();
        ...
        for(Grocery c : groceryList)
        {
            ...
            grocery.setQuatity("Qty: " + c.getQuatity());
    ...
    private void saveGroceryToDB(View v) {
        ...
        grocery.setQuatity(newGroceryQuantity);
